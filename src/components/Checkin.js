...
const userValidationSchema = yup.object({
  drivername: yup.string().required("Why not give your name?"),
  vehiclenumber: yup.string().required("Why not give the vehicle number?"),

  checkindate: yup.date().required("Checkin date required"),
});
